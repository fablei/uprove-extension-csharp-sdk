...
namespace UProveSample
{
    ...
    public class SDKSample
    {
        ...
        private static IssuerKeyAndParameters SetupUProveIssuer(string UIDP, int maxNumberOfAttributes, GroupType groupType = GroupType.Subgroup, bool supportDevice = false)
        {
        ...
        public static void SoftwareOnlySample()
        {
             ...
             *  issuer setup
             */
            IssuerKeyAndParameters ikap = SetupUProveIssuer("sample software-only issuer", 12, GroupType.ECC);
        ...
        public static void CollaborativeIssuanceAndEqualitySample()
        {
             ...
             */
            IssuerKeyAndParameters ikap1 = SetupUProveIssuer("issuer 1", 12);
            string ip1JSON = ikap1.IssuerParameters.Serialize();

            IssuerKeyAndParameters ikap2 = SetupUProveIssuer("issuer 2", 12);
        ...
        public static void DeviceSample()
        {
            ...
            IssuerKeyAndParameters ikap = SetupUProveIssuer("sample device-protected issuer", 12, GroupType.ECC, true);
            string ipJSON = ikap.IssuerParameters.Serialize();
        ...
        public static void RangeProofSample()
        {
            ...
            IssuerSetupParameters isp = new IssuerSetupParameters(12);
